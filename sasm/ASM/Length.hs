...
instance Length Opcode where
  ...
  insLength (ADC (ArithLabel _ _))  = 3
  ...
  insLength (INC (ArithLabel _ _))  = 3
  ...
  insLength (LDA (ArithLabel _ _))  = 3
  insLength (LDA (LabelLowByte _))  = 2
  insLength (LDA (LabelHighByte _)) = 2
  ...
  insLength (LDX (ArithLabel _ _))  = 3
  ...
  insLength (ROL (ArithLabel _ _))  = 3
  ...
  insLength (ROR (ArithLabel _ _))  = 3
  ...
  insLength (SBC (ArithLabel _ _))  = 3
  ...
  insLength (STA (ArithLabel _ _))  = 3
